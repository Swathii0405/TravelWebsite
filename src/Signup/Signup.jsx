            ...
            <div className="popup-content">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="input-container">
                        <i className="fas fa-envelope icon7"></i>
                        <input
                            type="email"
                            id="email"
                    ...
                    <div className="input-container">
                        <i className="fas fa-lock icon7"></i>
                        <input
                            type="password"
                            id="password"
                    ...
                    <img src={googleicon} className='social-icon' alt="Google logo" />Google
                    </button><br />
                    <button className='social-button'>
                    <img src={appleimg} className='social-icon' alt="Apple logo" />Apple
                    </button>
